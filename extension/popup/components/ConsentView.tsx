...
export function StopLoggingButton({ onStop }: StopLoggingButtonProps): React.JSX.Element {
  return (
    <button
      type='button'
      onClick={onStop}
      className='w-full py-2 px-4 rounded-md font-medium text-sm transition-colors bg-red-100 text-red-800 hover:bg-red-200 dark:bg-red-900 dark:text-red-200 dark:hover:bg-red-800'
    >
      Stop Logging
    </button>
  )
